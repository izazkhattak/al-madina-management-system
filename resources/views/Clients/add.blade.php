                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ isset($id) ? route('clients.update', $id) : route('clients.store') }}" method="POST">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <select {{ isset($isEditableProjectPlan) && $isEditableProjectPlan == 'no' ? 'disabled' : '' }} name="project_plan_id" class="form-control" id="project_plan_id" data-live-search="true">
                                        ...
                                        <option {{ (isset($project_plan_id) && $project_plan_id == $plan->id) || old('project_plan_id') == $plan->id ? 'selected' : '' }} value="{{ $plan->id }}">{{ $plan->project->title . ' - ' . $plan->installment_years . ' Years' }}</option>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" value="{{ old('total_amount', isset($edit_total_amount) ? number_format($edit_total_amount) : '') }}" name="total_amount" class="money-format-input form-control">
